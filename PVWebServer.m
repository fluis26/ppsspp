...
{
    if (!_handoffActivity) {
        _handoffActivity = [[NSUserActivity alloc] initWithActivityType:@"com.ppsspp.webserver"];
        _handoffActivity.title = @"PPSSPP file manager";
...
-(BOOL)startWWWUploadServer {
    ...
    NSDictionary *webSeverOptions = @{
                                      ...
                                      GCDWebServerOption_ServerName : @"PPSSPP",
                                      GCDWebServerOption_BonjourName : @"PPSSPPWWW",
...
-(BOOL)startWebDavServer {
    ...
    NSDictionary *webDavSeverOptions = @{
                                         GCDWebServerOption_AutomaticallySuspendInBackground : @(NO),
                                         GCDWebServerOption_ServerName : @"PPSSPP",
                                         GCDWebServerOption_BonjourName : @"PPSSPP",
